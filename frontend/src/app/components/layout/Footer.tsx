            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 mt-10">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-400">
                        <li><a href="#features" className="hover:text-gold-light">Funcionalidades</a></li>
                        <li><a href="#pricing" className="hover:text-gold-light">Preços</a></li>
                        <li><a href="#faq" className="hover:text-gold-light">FAQ</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-400">
                        <li><a href="#about" className="hover:text-gold-light">Sobre</a></li>
                        <li><a href="#contact" className="hover:text-gold-light">Contato</a></li>
