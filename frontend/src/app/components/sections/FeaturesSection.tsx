    ...
    const features = [
        {
            ...
            description: "Avalie o desempenho do seu portfólio com métricas avançadas e gráficos interativos.",
        ...
        },
        {
            ...
            description: "Acompanhe rentabilidade, diversificação e performance de todas as suas carteiras em um só lugar",
            actionText: "Saiba Mais"
        },
        {
            id: 6,
            title: "Alertas de Preço Personalizados",
            description: "Configure alertas para monitorar os preços dos ativos e receber notificações em tempo real.",
            actionText: "Saiba Mais"
        },
        {
            id: 7,
            title: "Insights & Relatórios",
            description: "Gere relatórios completos de performance, lucros e perdas para análise e imposto de renda",
            actionText: "Saiba Mais"
        },
        {
            id: 8,
    ...
    return (
        <section id="features" className="py-16 bg-bg-elevated">
            <div className="container">
                ...
                >
                    <h2 className="text-moss font-bold text-center mb-5">Tudo que você precisa para investir com inteligência</h2>
